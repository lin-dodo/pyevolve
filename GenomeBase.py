...
class GenomeBase:
   ...
   def __init__(self):
      ...
      self.fitness = 0.0
   ####
   def My_set(self,list_d,list_m,money,list_z):
      #self.internalParams=[list_d,list_m,money]888888888
      self.internalParams.update({0:list_d,1:list_m,2:money,3:list_z})
      
      
   def My_get_listdic(self):
      return self.internalParams
